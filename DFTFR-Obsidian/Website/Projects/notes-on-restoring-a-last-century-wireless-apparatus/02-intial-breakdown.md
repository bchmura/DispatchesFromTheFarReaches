---
title: Revelation of the innards
date: 2026-07-19
no: 2
isJournalEntry: true
category: projects
...
> The innards, useless to me, are going back into the antique radio ecosystem and will not be lost to time.  Each item was removed with care and kept as intact as it was upon receipt.  I've felt a sense of remorse in this project - somewhat tempered by the fact the unit was not operational as received, the shell would be kept intact - preserving the style of the time, and that the parts will find uses elsewhere. 

Taking apart the case was a lot easier than I thought it would be.  Removing several screw on the bottom allowed the entire inside to slide out the back.   I had expected it harder to deal with screws and such, but they were snug and easily came out.  The seventy years of accumulated grime reflected the age of the device.  

The entire internal assembly slides in to the back of the case, and much like a desk drawer, has the rear surface mounted on the assembly.  the bottom of the case itself has several grooves to make inserting easy and fool proof. 
...
This must be What changes the frequency? Although I'll have to look up and see what exactly that does. I'll say, you know, it's weird taking this apart that the last person to actually put hands-on some of this stuff inside was 75 years ago, and they're probably dead at this point. 

So that's weird. I do. Want to save the belt assembly, though, or at least the backing for it. 

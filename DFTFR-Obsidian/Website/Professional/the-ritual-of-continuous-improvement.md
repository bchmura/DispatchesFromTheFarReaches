...
1. Review improvements made last meeting.  Talk about how they turned out... keep doing, adjust, or stop.  If work from the previous meeting has not started, reconsider it in step 4.

2. Discuss what has gone well since the last meeting.  Talk over how you can extend that strength even farther with more changes.

3. Talk over what has not gone well.  Discuss potential changes to rectify the situation.

4.  Sort the changes in order of preference.  The preference can include most impactful, easiest to implement, pain relief etc.  Do not fixate on specific sorting rules.

...
1) Are we positive this component is needed in the system?  Don't build for "just in case".

2) Do we need it in the current iteration, or can it wait until later?  So much of what we think is important can turn out not to be.  

3) Does this component make sense in this process?  Does it move us closer or farther from our intention for it?

...
1. Capture lessons learned, good and bad. Add them to the document for future reference.

2. Discuss if iteration is possible. Can you salvage the learnings from this experiment into a new design? If so, record that and discuss it at the next meeting.

3. Clean up. Depending on the nature of the change, you could have work sitting in a now-defunct work flow. You will need to conclude or migrate this work before walking away.

4. Don't feel bad. You tried to make things better. This time it did not work out... that is to be expected. Focus on what you learned.
...
1. Discuss and record what you learned. Update the document.

2. Determine if you want to implement this as a permanent change or not. In some cases, you may have just wanted to learn something. In other cases you may want to introduce this as part of a larger initiative.

3. If you are moving forward, someone needs to brief the boss. A temporary experiment is one thing, a permanent change should be communicated.

4. Clean up. Depending on the nature of the change and how you move forward, you could have work sitting in a now-defunct work flow. You will need to conclude or migrate this work..

5. Promote the success. It never hurts to show people that you are doing good things in a unique way.
